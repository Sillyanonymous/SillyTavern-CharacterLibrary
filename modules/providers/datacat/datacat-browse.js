...
function updateDatacatFiltersButtonState() {
    ...
    if (!btn) return;
    const count = [datacatFilterHideOwned, datacatFilterHidePossible, datacatBookmarks.filterMyBookmarks, datacatFilterHideJanitor, datacatFilterHideSaucepan].filter(Boolean).length;
